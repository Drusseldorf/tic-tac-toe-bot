...
class RenderManager:
    ...
    def render(self):
        ...
        chat_id = self._game_session.user_one_id

        try:
            sent = getattr(bot, self._bot_attrbt(self._game_session.last_message_id_user_one))(**message_builder.message_body(chat_id))
